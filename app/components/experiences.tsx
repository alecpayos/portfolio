const ExperienceTimeline = ({
  ...
  return (
    <section className="mb-12 flex flex-col md:flex-row">
      ...
      <div className="mt-1 me-8 hidden flex-col items-center justify-between md:flex">
      ...
      <div className="mt-4 flex flex-col md:mt-0">
        ...
        <ul className="px-6 text-lg text-zinc-400 sm:pe-8 md:max-w-[640px]">
...
export default function Experiences() {
  ...
  return (
    <div className="screen min-w-[320px] screen-secondary sm:!items-start md:!items-center">
      <h1 className="mb-8 !self-center !text-5xl screen-header md:mb-16">
        Experiences
      </h1>
      ...
      <ExperienceTimeline
        ...
        company="Wend PH Inc, Cebu"
        description={midExperience}
      />
      <ExperienceTimeline
        year={2020}
        title="Junior Web Developer"
        company="Wend PH Inc, Cebu"
        description={juniorExperience}
      />
      <ExperienceTimeline
        year={2019}
        title="Freelance Web Developer"
        company="Tacloban"
        description={freelanceExp}
      />
    </div>
  )
}
