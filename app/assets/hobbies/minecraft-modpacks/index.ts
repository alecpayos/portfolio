...
const projectArchitectTwo = {
  ...
  packLink:
    "https://www.curseforge.com/minecraft/modpacks/project-architect-2",
...
const universio = {
  ...
  alt: "UniversIO Icon",
  proofs: [uioFinalStar1, uioFinalStar2],
}
...
const mysticalBlock = {
  ...
  proofs: [mbCreativeChest, mbAllAchievements1, mbAllAchievements2],
}
