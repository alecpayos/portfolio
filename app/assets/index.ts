...
const awsIcons = {
  ...
  awsRdsIcon: {
    icon: awsRdsIcon,
    alt: "AWS RDS",
    link: "https://aws.amazon.com/free/database/",
  },
  awsS3Icon: {
    icon: awsS3Icon,
    alt: "AWS S3",
...
const operatingSystemIcons = {
  appleIcon: {
    icon: appleIcon,
    alt: "MacOS Icon",
    link: "https://www.apple.com/ph/macos/sonoma/",
  },
  microsoftWindowsIcon: {
    icon: microsoftWindowsIcon,
    alt: "Windows",
    link: "https://www.microsoft.com/en-ph/windows?r=1",
  },
  ubuntuIcon: {
    icon: ubuntuIcon,
    alt: "Ubuntu",
